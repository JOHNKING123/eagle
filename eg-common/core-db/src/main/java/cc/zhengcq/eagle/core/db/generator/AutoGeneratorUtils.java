...
public class AutoGeneratorUtils {
    ...
    final static String SUPER_ENTITY_CLASS = "cc.zhengcq.eagle.core.db.base.BaseModel";
    final static String SUPER_MAPPER_CLASS = "cc.zhengcq.eagle.core.db.base.BaseDao";
    final static String SUPER_SERVICE_CLASS = "cc.zhengcq.eagle.core.db.base.BaseService";
    final static String SUPER_SERVICE_IMPL_CLASS = "cc.zhengcq.eagle.core.db.base.BaseServiceImpl";
    ...
    //公共包名称
    final static String PACKAGE_PARENT = "cc.zhengcq.eagle";
